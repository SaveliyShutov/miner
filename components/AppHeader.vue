...
<template>
    <div class="fixed bottom-0 left-0 z-50 w-full h-16">
        <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
                <button @click="router.push('/miner')" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
            ...
            <button type="button"
                ...
                <span
                    class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500">Wallet</span>
            </button>
            <button type="button"
                class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                <svg class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500"
                ...
                <span
                    class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-emerald-600 dark:group-hover:text-emerald-500">Settings</span>
            </button>
        </div>
    </div>
</template>
